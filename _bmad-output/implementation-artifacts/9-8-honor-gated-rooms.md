...
- **Five items deferred** to `deferred-work.md` (Open Questions 1, 4, 5, 6, plus a stale 9.7 down-migration comment left untouched per the scope guardrails). All five were raised by the story itself as non-blocking.
